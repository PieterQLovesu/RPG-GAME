    ...
    
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            if ((PlayerPicture.Left == pictureBat.Left) && (PlayerPicture.Top == pictureBat.Top) && pictureBat.Visible)
            {
                HpPlayer -= 1;
        ...
        public void MoveBat()
        {
            ...
            if (pictureBat.Top >= 65 && pictureBat.Top <= 180 && pictureBat.Left >= 85 && pictureBat.Left <= 480)
            {
                ...
                else if (PlayerPicture.Left > pictureBat.Left && PlayerPicture.Top == pictureBat.Top)
                {
                    pictureBat.Left += 30;
                    AttackBat();
                }
                else if (pictureBat.Left >= PlayerPicture.Left && PlayerPicture.Top == pictureBat.Top)
                {
                    pictureBat.Left -= 30;
                    AttackBat();
                }
                else if (PlayerPicture.Left == pictureBat.Left && pictureBat.Top > PlayerPicture.Top)
                {
                    pictureBat.Top -= 30;
                    AttackBat();

                }
                else if (rndRuch.Next(0, 3) == 0)
                {
                    pictureBat.Top += 30;
                    AttackBat();

                }
                else if (rndRuch.Next(0, 3) == 1)
                {
                    pictureBat.Top -= 30;

                }
                else if (rndRuch.Next(0, 3) == 2)
                {
                    pictureBat.Left += 30;
                }
                else if (rndRuch.Next(0, 3) == 3)
                {
                    pictureBat.Left -= 30;
                }
            }
            ...
            { pictureBat.Top += 30; }
            else if (pictureBat.Top >= 160)
            { pictureBat.Top -= 30; }
            else if (pictureBat.Left >= 460)
            { pictureBat.Left -= 30; }
            else if (pictureBat.Left <= 90)
            { pictureBat.Left += 30; }
        }
